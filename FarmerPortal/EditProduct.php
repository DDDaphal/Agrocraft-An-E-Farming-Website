                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form title="my-form" action="InsertProduct.php" method="post" enctype="multipart/form-data">
                                <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <label for="nid_number" class="col-md-4 col-form-label text-md-right text-center font-weight-bolder"> Price (Per kg) :</label>
                                        <div class="col-md-6">
                                    ...
                                    <!-- <div class="form-group row">
                                        <label for="nid_number1" class="col-md-4 col-form-label text-md-right text-center font-weight-bolder">Price (Per kg)</label>
                                        <div class="col-md-6">
